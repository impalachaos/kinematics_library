...
class TransformTest : public testing::TestWithParam<QTransformTestParams>
{};

TEST_P(TransformTest, Compute)
{
    QTransformTestParams params = GetParam();
    ...
    error = quaternion_transform(input1, input2, resultPtr);
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ...
        QTransformTestParams{
            ...
            {-2.1, 1.7, 2.0},                                             // input2
            {-0.161604570867822, -2.146160976679182, -2.582223271689357}, // want
            1.0E-14,                                                      // near
            KL_NO_ERROR                                                   // wantError
        }),
    [](const ::testing::TestParamInfo<QTransformTestParams> &info) -> std::string {
