...
class AerToNedTest : public testing::TestWithParam<AerToNedTestParams>
{};

TEST_P(AerToNedTest, Compute)
{
    AerToNedTestParams params = GetParam();
    ...
    int error = transform_aer_to_ned(input1, input2);
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ...
        AerToNedTestParams{
            ...
            false,                                     // input1Null
            false,                                     // input2Null
            {30 * PI / 180, 40 * PI / 180, -70},       // input1
            {0.0, 0.0, 0.0},                           // input2
            {-46.43897628, -26.81155573, 44.99513264}, // want
            1.0E-6,                                    // near
            KL_NO_ERROR                                // wantError
        }),
    [](const ::testing::TestParamInfo<AerToNedTestParams> &info) -> std::string {
